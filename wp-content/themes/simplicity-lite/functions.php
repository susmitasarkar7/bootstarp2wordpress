...
//	function tied to the excerpt_more filter hook.
	...
	function simplicity_creditline() { echo '<span class="credit">| Simplicity Theme by: <a href="'.esc_url('https://d5creation.com').'" target="_blank"><img  src="' . get_template_directory_uri() . '/images/d5logofooter.png" /> D5 Creation</a> | Powered by: <a href="http://wordpress.org" target="_blank">WordPress</a></span>'; }
